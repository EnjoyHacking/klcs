...
pkgdatadir = $(datadir)/klcs
pkgincludedir = $(includedir)/klcs
pkglibdir = $(libdir)/klcs
pkglibexecdir = $(libexecdir)/klcs
...
lcstext_LINK = $(CCLD) $(AM_CFLAGS) $(CFLAGS) $(lcstext_LDFLAGS) \
	$(LDFLAGS) -o $@
am_main_OBJECTS = main.$(OBJEXT) lst_algorithms.$(OBJEXT) \
	lst_debug.$(OBJEXT) lst_stree.$(OBJEXT) lst_string.$(OBJEXT) \
	utils.$(OBJEXT) hash-int.$(OBJEXT) compare-int.$(OBJEXT) \
...
main_LINK = $(CCLD) $(AM_CFLAGS) $(CFLAGS) $(main_LDFLAGS) $(LDFLAGS) \
	-o $@
am_test_convertion_OBJECTS = test_convertion.$(OBJEXT) \
	convertion.$(OBJEXT) lst_string.$(OBJEXT) trie.$(OBJEXT) \
	position_constraints.$(OBJEXT) hash-table.$(OBJEXT) \
	hash-int.$(OBJEXT) compare-int.$(OBJEXT) \
	pattern_search.$(OBJEXT)
test_convertion_OBJECTS = $(am_test_convertion_OBJECTS)
test_convertion_LDADD = $(LDADD)
...
OBJEXT = o
PACKAGE = klcs
PACKAGE_BUGREPORT = sangyafei1026@gmail.com
PACKAGE_NAME = klcs
PACKAGE_STRING = klcs 1.0
PACKAGE_TARNAME = klcs
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
lcstext$(EXEEXT): $(lcstext_OBJECTS) $(lcstext_DEPENDENCIES) $(EXTRA_lcstext_DEPENDENCIES) 
	@rm -f lcstext$(EXEEXT)
	$(AM_V_CCLD)$(lcstext_LINK) $(lcstext_OBJECTS) $(lcstext_LDADD) $(LIBS)

main$(EXEEXT): $(main_OBJECTS) $(main_DEPENDENCIES) $(EXTRA_main_DEPENDENCIES) 
	@rm -f main$(EXEEXT)
	$(AM_V_CCLD)$(main_LINK) $(main_OBJECTS) $(main_LDADD) $(LIBS)

test_convertion$(EXEEXT): $(test_convertion_OBJECTS) $(test_convertion_DEPENDENCIES) $(EXTRA_test_convertion_DEPENDENCIES) 
	@rm -f test_convertion$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(test_convertion_OBJECTS) $(test_convertion_LDADD) $(LIBS)
